...
login_Url = 'https://sso.donga.ac.kr/svc/tk/Auth.eps?id=studentnew&ac=Y&ifa=N&RelayState=%2fSudExam%2fSUD%2fXSUN0040.aspx&'  # 통합 로그인
...
try:
    ...
    json_Result['error'] = "-2" # 데이터 제대로 안 옴
